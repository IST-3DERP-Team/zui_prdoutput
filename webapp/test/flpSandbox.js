		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zuiprodoutput-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuiprodoutput-display": {
								"semanticObject": "zuiprodoutput",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuiprodoutput",
									"url": sap.ui.require.toUrl("zuiprodoutput")
								}
							}
						}
					}
