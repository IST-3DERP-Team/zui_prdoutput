	...
	return {
        ...
        openLoadingDialog: function(doc) {
			if (!doc._LoadingDialog) {
				doc._LoadingDialog = sap.ui.xmlfragment("zuiprodoutput.view.fragments.dialog.LoadingDialog", doc);
        ...
        openProcessingDialog(doc, msg) {
            if (!doc._ProcessingDialog) {
                doc._ProcessingDialog = sap.ui.xmlfragment("zuiprodoutput.view.fragments.dialog.ProcessingDialog", doc);
